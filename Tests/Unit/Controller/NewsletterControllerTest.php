...
/**
 * Test case for class LEO\NewsletterMan\Controller\NewsletterController.
 *
...
class NewsletterControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \LEO\NewsletterMan\Controller\NewsletterController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('LEO\\NewsletterMan\\Controller\\NewsletterController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllNewslettersFromRepositoryAndAssignsThemToView() {
		...
		$newsletterRepository = $this->getMock('LEO\\NewsletterMan\\Domain\\Repository\\NewsletterRepository', array('findAll'), array(), '', FALSE);
